...
public class CustomRichEditor extends WebView {
    ...
    protected CustomRichEditor.EditorWebViewClient createWebviewClient() {
        return new CustomRichEditor.EditorWebViewClient();
    }
    ...
    public void setOnDecorationChangeListener(RichEditor.OnDecorationStateListener listener) {
        mDecorationStateListener = listener;
    }

    public void setOnInitialLoadListener(RichEditor.AfterInitialLoadListener listener) {
