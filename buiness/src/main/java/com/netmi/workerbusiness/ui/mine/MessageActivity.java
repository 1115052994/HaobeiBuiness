...
import com.netmi.workerbusiness.databinding.ActivityMessageBinding;
...
//        rightSetting.setTextColor(Color.parseColor("#007AFF"));
    ...
    public void doClick(View view) {
        ...
        if (code != -1) {
            //查看是否拥有相机权限
            mCurrentStep = 1;
            if (new PermissionUtils().checkPermission(permissions, MessageActivity.this)) {
                openAlbum(code);
            } else {
                PermissionUtils.checkAndRequestPermissions(MessageActivity.this, permissions);
            }
        }
    }
        ...
        RetrofitApiFactory.createApi(com.netmi.workerbusiness.data.api.MineApi.class)
                ...
                .subscribe(new XObserver<BaseData<GetApplyInfo>>() {
                    ...
                    public void onSuccess(BaseData<GetApplyInfo> data) {
                        ActivityMessageBinding mBinding = (ActivityMessageBinding) MessageActivity.this.mBinding;
