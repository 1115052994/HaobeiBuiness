...
import com.netease.nim.uikit.business.contact.HeaderClickCallback;
...
import static com.netease.nim.uikit.business.recent.holder.RecentViewHolder.RECENT_TAG_STICKY;
...
//        emptyHint.setHint("还没有会话，在通讯录中找个人聊聊吧！");
    ...
    private void initAdapterHeader() {
        View platformNotice = LayoutInflater.from(getActivity()).inflate(R.layout.nim_recent_contacts_header_platform, null);
        platformNotice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //平台公告
                if (headerClickCallback != null) {
                    headerClickCallback.doClick(HeaderClickCallback.platformNotice, v);
                }
        ...
        View orderNotice = LayoutInflater.from(getActivity()).inflate(R.layout.nim_recent_contact_header_order, null);
        orderNotice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //订单消息
                if (headerClickCallback != null) {
                    headerClickCallback.doClick(HeaderClickCallback.orderNotice, v);
                }
                // type_arr  1 平台公告  2订单通知  5 系统通知
                Bundle args = new Bundle();
        ...
        View systemNotify = LayoutInflater.from(getActivity()).inflate(R.layout.nim_recent_contacts_header, null);
        systemNotify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //系统通知
                if (headerClickCallback != null) {
                    headerClickCallback.doClick(HeaderClickCallback.systemNotify, v);
                }
                // type_arr  1 平台公告  2订单通知  5 系统通知
                Bundle args = new Bundle();
        ...
        adapter.addHeaderView(platformNotice);
        adapter.addHeaderView(orderNotice);
        adapter.addHeaderView(systemNotify);
