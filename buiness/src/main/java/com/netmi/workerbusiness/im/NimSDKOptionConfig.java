package com.netmi.workerbusiness.im;
...
import com.netmi.workerbusiness.ui.SplashActivity;
...
public class NimSDKOptionConfig {
    ...
    public static SDKOptions getSDKOptions(Context context) {
        ...
        // 通知栏显示用户昵称和头像
        options.userInfoProvider = new NimUserInfoProvider(com.netmi.workerbusiness.im.DemoCache.getContext());
    ...
    public static String getAppCacheDir(Context context) {
        ...
        if (TextUtils.isEmpty(storageRootPath)) {
            ...
            storageRootPath = Environment.getExternalStorageDirectory() + "/" + com.netmi.workerbusiness.im.DemoCache.getContext().getPackageName();
        }
    ...
    private static void initStatusBarNotificationConfig(SDKOptions options) {
        ...
        StatusBarNotificationConfig userConfig = com.netmi.workerbusiness.im.config.preference.UserPreferences.getStatusConfig();
        if (userConfig == null) {
            userConfig = config;
        } else {
        ...
        // 持久化生效
        com.netmi.workerbusiness.im.config.preference.UserPreferences.setStatusConfig(userConfig);
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        config.notificationColor = com.netmi.workerbusiness.im.DemoCache.getContext().getResources().getColor(R.color.color_blue_3a9efb);
        // 通知铃声的uri字符串
        ...
        // save cache，留做切换账号备用
        com.netmi.workerbusiness.im.DemoCache.setNotificationConfig(config);
        return config;
    }
