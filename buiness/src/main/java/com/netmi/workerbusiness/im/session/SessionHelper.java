package com.netmi.workerbusiness.im.session;
...
import com.netease.nim.uikit.business.session.actions.PhotographAction;
...
import com.netmi.workerbusiness.im.session.action.FileAction;
import com.netmi.workerbusiness.im.session.action.GuessAction;
import com.netmi.workerbusiness.im.session.activity.MessageHistoryActivity;
import com.netmi.workerbusiness.im.session.extension.CustomAttachParser;
import com.netmi.workerbusiness.im.session.extension.CustomAttachment;
import com.netmi.workerbusiness.im.session.extension.GoodAttachment;
import com.netmi.workerbusiness.im.session.extension.GuessAttachment;
import com.netmi.workerbusiness.im.session.extension.OrderAttachment;
import com.netmi.workerbusiness.im.session.extension.StickerAttachment;
import com.netmi.workerbusiness.im.session.search.SearchMessageActivity;
import com.netmi.workerbusiness.im.session.viewholder.MsgViewHolderDefCustom;
import com.netmi.workerbusiness.im.session.viewholder.MsgViewHolderFile;
import com.netmi.workerbusiness.im.session.viewholder.MsgViewHolderGood;
import com.netmi.workerbusiness.im.session.viewholder.MsgViewHolderGuess;
import com.netmi.workerbusiness.im.session.viewholder.MsgViewHolderOrder;
import com.netmi.workerbusiness.im.session.viewholder.MsgViewHolderSticker;
import com.netmi.workerbusiness.im.session.viewholder.MsgViewHolderTip;
...
//                    RobotProfileActivity.start(context, sessionId); //打开聊天信息
                    ToastHelper.showToast(context, "机器人：" + sessionId);
                }
            };
    ...
    private static void registerViewHolders() {
        ...
        NimUIKit.registerMsgItemViewHolder(GoodAttachment.class, MsgViewHolderGood.class);
