package com.netmi.workerbusiness.im.session.search;
...
import com.netmi.workerbusiness.databinding.MessageSearchActivityBinding;
 ...
 */
public class SearchMessageActivity extends BaseActivity<MessageSearchActivityBinding> {
    ...
    protected void initUI() {
        ...
        mBinding.messageSerach.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                    if (TextUtils.isEmpty(mBinding.messageSerach.getText().toString().trim())) {
                        ToastHelper.showToast(getContext(), "请先输入搜索内容");
                    } else {
                        searchByKeyword(mBinding.messageSerach.getText().toString().trim());
                        showKeyboard(false);
                    }
                    return true;
                }
