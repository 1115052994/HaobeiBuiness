...
import com.netmi.workerbusiness.im.event.OnlineStateEventManager;
    ...
    private void registerIMMessageFilter() {
        NIMClient.getService(MsgService.class).registerIMMessageFilter(new IMMessageFilter() {
            ...
            public boolean shouldIgnore(IMMessage message) {
                if (com.netmi.workerbusiness.im.config.preference.UserPreferences.getMsgIgnore() && message.getAttachment() != null) {
