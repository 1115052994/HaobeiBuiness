...
public class ImagePickerLauncher {
    ...
    //选择
    public static final int IMAGE_PICK = 0;
    ...
    public static void selectImage(final Activity context, final int requestCode, @NonNull final ImagePickerOption option, int titleResId, int imageType) {
        if (context == null) {
            return;
        }
        switch (imageType) {
