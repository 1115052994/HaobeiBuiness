...
public class PickImageHelper {
    ...
    public static void pickPhotos(final Context context, final int requestCode, final PickImageOption option) {
        if (context == null) {
            return;
        }
        int from = PickImageActivity.FROM_LOCAL;
    ...
    public static void camera(final Context context, final int requestCode, final PickImageOption option) {
        if (context == null) {
            return;
        }
        int from = PickImageActivity.FROM_CAMERA;
