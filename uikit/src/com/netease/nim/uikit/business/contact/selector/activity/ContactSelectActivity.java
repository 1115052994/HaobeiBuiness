...
import com.netease.nim.uikit.databinding.NimContactsSelectBinding;
 ...
 */
public class ContactSelectActivity extends BaseActivity<NimContactsSelectBinding> implements View.OnClickListener, android.support.v7.widget.SearchView.OnQueryTextListener {
    ...
    protected int getContentView() {
        return R.layout.nim_contacts_select;
    }

    @Override
    protected void initUI() {
        getTvTitle().setText("选择联系人");
        parseIntentData();
        initAdapter();
        initListView();
    ...
    private void initListView() {
        listView = mBinding.contactListView;
