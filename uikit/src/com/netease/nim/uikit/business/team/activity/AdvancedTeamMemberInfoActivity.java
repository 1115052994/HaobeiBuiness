...
import com.netease.nim.uikit.databinding.NimAdvancedTeamMemberInfoLayoutBinding;
 ...
 */
public class AdvancedTeamMemberInfoActivity extends BaseActivity<NimAdvancedTeamMemberInfoLayoutBinding> implements View.OnClickListener {
...
//            editNickname();
            //修改群昵称
            View view = LayoutInflater.from(AdvancedTeamMemberInfoActivity.this).inflate(R.layout.nim_dialog_input,null);
            final AlertDialog alertDialog = new AlertDialog.Builder(AdvancedTeamMemberInfoActivity.this,R.style.Theme_AppCompat_Light_Dialog_Alert).setView(view).create();
            final EditText etNote = view.findViewById(R.id.et_note);
            TextView title = view.findViewById(R.id.tv_title);
            TextView tvCancel = view.findViewById(R.id.tv_cancel);
            TextView tvConfirm = view.findViewById(R.id.tv_confirm);
            title.setText("群昵称");
            etNote.setText(TextUtils.isEmpty(nickName.getText().toString()) ? "" : nickName.getText().toString());
            ...
            tvConfirm.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (TextUtils.isEmpty(etNote.getText().toString())){
                        ...
                        showKeyboard(false);
                        alertDialog.dismiss();
                        setNickname(etNote.getText().toString());
                    }
