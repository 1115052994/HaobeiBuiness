...
public abstract class PickImageAction extends BaseAction {
    ...
    public void onClick() {
        ...
        showSelector(getTitleId(), requestCode, multiSelect, -1);
    }

    /**
     * 打开图片选择器
     */
    public void showSelector(int titleId, final int requestCode, final boolean multiSelect, int imageType) {
        ...
        ImagePickerLauncher.selectImage(getActivity(), requestCode, option, titleId, imageType);
    }
