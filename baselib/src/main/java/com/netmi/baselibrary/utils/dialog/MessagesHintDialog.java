package com.netmi.baselibrary.utils.dialog;
...
public class MessagesHintDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogBindMessageBinding = DataBindingUtil.inflate(LayoutInflater.from(getContext()), R.layout.dialog_message_hint, null, false);
