...
public class MyConvenientBanner<T> extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        final ScrollSpeedLinearLayoutManger linearLayoutManager = new ScrollSpeedLinearLayoutManger(context, LinearLayoutManager.HORIZONTAL, false);
     ...
     * @return
     */
    public MyConvenientBanner setPageIndicatorAlign(ConvenientBanner.PageIndicatorAlign align) {
        LayoutParams layoutParams = (LayoutParams) loPageTurningPoint.getLayoutParams();
        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT, align == ConvenientBanner.PageIndicatorAlign.ALIGN_PARENT_LEFT ? RelativeLayout.TRUE : 0);
        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT, align == ConvenientBanner.PageIndicatorAlign.ALIGN_PARENT_RIGHT ? RelativeLayout.TRUE : 0);
        layoutParams.addRule(RelativeLayout.CENTER_HORIZONTAL, align == ConvenientBanner.PageIndicatorAlign.CENTER_HORIZONTAL ? RelativeLayout.TRUE : 0);
